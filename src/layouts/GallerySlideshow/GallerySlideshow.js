    ...
    return (
      ...
      >
        ...
        <ImageGallery items={galleryMap.map(item => ({ original: item.sourceUrl , thumbnail: item.sourceUrl }))}/>
            ...
            {galleryMap.map(imageSrc => (
                <div>
                    <GatsbyImage className={"image-main"} image={imageSrc.original.childImageSharp.gatsbyImageData} alt={`${imageSrc.title} Main Image`} />
                    <GatsbyImage className={"image-thumb"} image={imageSrc.thumbnail.childImageSharp.gatsbyImageData} alt={`${imageSrc.title} Thumbnail`} />
                </div>
            ))}
        </div>
      </BlockContent>
